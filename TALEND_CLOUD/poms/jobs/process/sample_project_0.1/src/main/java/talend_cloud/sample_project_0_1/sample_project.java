...
package talend_cloud.sample_project_0_1;
 ...
 * @status
 */
public class sample_project implements TalendJob {
	...
	private final String jobName = "sample_project";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					sample_project.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(sample_project.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TALEND_CLOUD_sample_project) {
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final sample_project sample_projectClass = new sample_project();

		int exitCode = sample_projectClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = sample_project.class.getClassLoader()
					.getResourceAsStream("talend_cloud/sample_project_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = sample_project.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : sample_project");
		}
		if (enableLogStash) {
